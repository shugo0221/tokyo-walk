...
export const courses: Course[] = [
  ...
  // 公園メインコース（id: 101〜130）
  {
    ...
    seasons: ["春", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "日本庭園・フランス式庭園・イギリス風景式庭園が調和する都心のオアシス。桜と紅葉の名所。",
    startPoint: "新宿御苑前駅",
    endPoint: "千駄ヶ谷駅",
    waypoints: ["新宿御苑 新宿門", "日本庭園", "温室", "イギリス風景式庭園"],
    durationNote: "庭園内をゆっくり散策する時間です",
    highlights: ["約1000本の桜", "日本庭園の池泉回遊", "大温室の熱帯植物", "広大な芝生広場"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "新宿御苑前駅から徒歩5分、入園料500円",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "井の頭池を中心とした自然豊かな公園。ボートや弁財天、自然文化園も楽しめます。",
    startPoint: "吉祥寺駅",
    endPoint: "井の頭公園駅",
    waypoints: ["井の頭池", "弁財天", "井の頭自然文化園"],
    durationNote: "池周辺の散策時間です",
    highlights: ["池を囲む桜並木", "スワンボート", "弁財天のパワースポット", "カフェが充実"],
    recommendedTimes: ["朝", "昼", "夕方"],
    difficulty: "初心者向け",
    accessInfo: "吉祥寺駅から徒歩5分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天"],
    description: "都心にありながら広大な森林が広がる公園。サイクリングやピクニックに最適。",
    startPoint: "原宿駅",
    endPoint: "代々木公園駅",
    waypoints: ["代々木公園 中央広場", "バラ園", "噴水広場"],
    durationNote: "公園内を一周する時間です",
    highlights: ["広大な森林エリア", "中央広場でピクニック", "バラ園（春・秋）", "週末のイベント"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "原宿駅から徒歩3分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "秋", "冬"],
    weatherStyles: ["晴天", "曇天", "雨天"],
    description: "博物館・美術館が集まる文化の森。不忍池や動物園もあり一日中楽しめます。",
    startPoint: "上野駅",
    endPoint: "鶯谷駅",
    waypoints: ["西郷隆盛像", "不忍池", "東京国立博物館前"],
    durationNote: "美術館・博物館見学は含みません",
    highlights: ["約1200本の桜", "不忍池のボート", "美術館・博物館巡り", "上野大仏"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "上野駅から徒歩2分",
    hasPark: true,
  },
  {
    id: 105,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天"],
    description: "広大な敷地に四季折々の花が咲き誇る国営公園。サイクリングやBBQも楽しめます。",
    startPoint: "西立川駅",
    endPoint: "立川駅",
    waypoints: ["みんなの原っぱ", "日本庭園", "コスモスの丘"],
    durationNote: "レンタサイクル利用推奨",
    highlights: ["チューリップ畑", "銀杏並木", "コスモス畑", "日本庭園の紅葉"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "西立川駅から徒歩2分、入園料450円",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "23区内唯一の渓谷。木々に囲まれた渓流沿いを歩く癒しスポット。",
    startPoint: "等々力駅",
    endPoint: "等々力駅",
    waypoints: ["等々力渓谷入口", "不動の滝", "等々力不動尊", "日本庭園"],
    durationNote: "渓谷を往復する時間です",
    highlights: ["渓谷の涼しい空気", "不動の滝", "等々力不動尊", "古墳群"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "等々力駅から徒歩3分",
    hasPark: true,
  },
  {
    id: 107,
    ...
    seasons: ["春", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "徳川五代将軍綱吉の側用人が築いた名園。しだれ桜と紅葉のライトアップが有名。",
    startPoint: "駒込駅",
    endPoint: "駒込駅",
    waypoints: ["六義園正門", "しだれ桜", "つつじ茶屋", "藤代峠"],
    durationNote: "庭園をゆっくり一周する時間です",
    highlights: ["しだれ桜（春）", "紅葉ライトアップ（秋）", "つつじ茶屋", "回遊式築山泉水庭園"],
    recommendedTimes: ["昼", "夕方"],
    difficulty: "初心者向け",
    accessInfo: "駒込駅から徒歩7分、入園料300円",
    hasPark: true,
  },
  {
    id: 108,
    ...
    seasons: ["春", "秋", "冬"],
    weatherStyles: ["晴天", "曇天"],
    description: "潮入の池と都心のビル群のコントラストが美しい庭園。お茶屋で抹茶を楽しめます。",
    startPoint: "汐留駅",
    endPoint: "築地市場駅",
    waypoints: ["大手門", "潮入の池", "中島の御茶屋", "三百年の松"],
    durationNote: "お茶屋での休憩時間は含みません",
    highlights: ["潮入の池", "中島の御茶屋で抹茶", "三百年の松", "菜の花畑（春）"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "汐留駅から徒歩7分、入園料300円",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天"],
    description: "広い芝生広場とファミリーパークが魅力。桜の時期は花見客で賑わいます。",
    startPoint: "用賀駅",
    endPoint: "用賀駅",
    waypoints: ["砧公園入口", "芝生広場", "世田谷美術館"],
    durationNote: "公園内をゆっくり散策する時間です",
    highlights: ["広大な芝生広場", "ファミリーパーク", "世田谷美術館", "桜の名所"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "用賀駅から徒歩20分またはバス",
    hasPark: true,
  },
  {
    id: 110,
    name: "駒沢オリンピック公園 スポーツコース",
    duration: 60,
    distance: 4.0,
    area: "駒沢",
    seasons: ["春", "夏", "秋", "冬"],
    weatherStyles: ["晴天", "曇天"],
    description: "1964年東京オリンピックの会場跡地。ジョギングやサイクリングが人気。",
    startPoint: "駒沢大学駅",
    endPoint: "駒沢大学駅",
    waypoints: ["中央広場", "ジョギングコース", "オリンピック記念塔"],
    durationNote: "外周コースを一周する時間です",
    highlights: ["2.1kmジョギングコース", "サイクリングコース", "オリンピック記念塔", "ドッグラン"],
    recommendedTimes: ["朝", "夕方"],
    difficulty: "初心者向け",
    accessInfo: "駒沢大学駅から徒歩15分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "三菱財閥が築いた回遊式林泉庭園。全国から集めた名石が見どころ。",
    startPoint: "清澄白河駅",
    endPoint: "清澄白河駅",
    waypoints: ["清澄庭園入口", "大泉水", "涼亭"],
    durationNote: "庭園内を一周する時間です",
    highlights: ["全国から集めた名石", "大泉水", "涼亭", "カフェの街散策も"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "清澄白河駅から徒歩3分、入園料150円",
    hasPark: true,
  ...
  {
    id: 112,
    name: "小石川後楽園 水戸黄門ゆかりの庭",
    duration: 60,
    distance: 2.0,
    area: "後楽園",
    seasons: ["春", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "水戸徳川家の上屋敷に造られた回遊式庭園。中国の名所を模した景観が特徴。",
    startPoint: "後楽園駅",
    endPoint: "飯田橋駅",
    waypoints: ["小石川後楽園入口", "大泉水", "円月橋", "得仁堂"],
    durationNote: "庭園をゆっくり散策する時間です",
    highlights: ["円月橋", "大泉水", "しだれ桜", "紅葉"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "後楽園駅から徒歩8分、入園料300円",
    hasPark: true,
  },
  {
    id: 113,
    ...
    seasons: ["春", "夏", "秋", "冬"],
    weatherStyles: ["晴天", "曇天"],
    description: "日本初の近代的洋風公園。都心のビジネス街に緑のオアシスが広がります。",
    startPoint: "日比谷駅",
    endPoint: "霞ヶ関駅",
    waypoints: ["日比谷公園大噴水", "心字池", "松本楼"],
    durationNote: "公園内を散策する時間です",
    highlights: ["大噴水", "野外音楽堂", "バラ園", "松本楼でランチ"],
    recommendedTimes: ["昼", "夕方"],
    difficulty: "初心者向け",
    accessInfo: "日比谷駅から徒歩2分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "旧江戸城の本丸・二の丸・三の丸跡を整備した庭園。無料で楽しめる都心の緑。",
    startPoint: "大手町駅",
    endPoint: "竹橋駅",
    waypoints: ["大手門", "百人番所", "天守台", "二の丸庭園"],
    durationNote: "御苑内を散策する時間です",
    highlights: ["江戸城天守台跡", "二の丸庭園", "百人番所", "季節の花々"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "大手町駅から徒歩5分、入園無料（月金休園）",
    hasPark: true,
  },
  {
    id: 115,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天"],
    description: "東京湾を望む広大な公園。水族園、観覧車、鳥類園など見どころ満載。",
    startPoint: "葛西臨海公園駅",
    endPoint: "葛西臨海公園駅",
    waypoints: ["葛西臨海水族園", "ダイヤと花の大観覧車", "鳥類園", "なぎさ橋"],
    durationNote: "水族園見学は含みません",
    highlights: ["大観覧車", "東京湾の眺望", "鳥類園", "バーベキュー広場"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "葛西臨海公園駅から徒歩1分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "都内最大級の水郷公園。メタセコイアの森や花菖蒲園が美しい。",
    startPoint: "金町駅",
    endPoint: "金町駅",
    waypoints: ["水元公園バス停", "メタセコイアの森", "花菖蒲園", "水元大橋"],
    durationNote: "バス移動時間を含みます",
    highlights: ["メタセコイアの森", "花菖蒲園（6月）", "野鳥観察", "バーベキュー広場"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "金町駅からバス20分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "三宝寺池と石神井池を中心とした緑豊かな公園。野鳥や水辺の生き物が観察できます。",
    startPoint: "石神井公園駅",
    endPoint: "石神井公園駅",
    waypoints: ["石神井池", "三宝寺池", "水辺観察園"],
    durationNote: "両池を周遊する時間です",
    highlights: ["三宝寺池の自然", "ボート遊び", "野鳥観察", "石神井城跡"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "石神井公園駅から徒歩7分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天"],
    description: "練馬区最大の公園。広大な芝生広場と銀杏並木が魅力。",
    startPoint: "光が丘駅",
    endPoint: "光が丘駅",
    waypoints: ["光が丘公園入口", "芝生広場", "銀杏並木", "バードサンクチュアリ"],
    durationNote: "公園内を周遊する時間です",
    highlights: ["広大な芝生広場", "銀杏並木（秋）", "バードサンクチュアリ", "バーベキュー場"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "光が丘駅から徒歩8分",
    hasPark: true,
  },
  {
    id: 119,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "善福寺池を中心とした閑静な公園。野鳥観察やボート遊びが楽しめます。",
    startPoint: "西荻窪駅",
    endPoint: "上石神井駅",
    waypoints: ["善福寺池", "上の池", "遅野井川"],
    durationNote: "池周辺を散策する時間です",
    highlights: ["善福寺池のボート", "野鳥観察", "静かな住宅街", "カワセミ生息地"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "西荻窪駅からバス10分",
    hasPark: true,
  },
  {
    id: 120,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "野川沿いに広がる自然豊かな公園。自然観察園では湧水や野草が楽しめます。",
    startPoint: "新小金井駅",
    endPoint: "多磨駅",
    waypoints: ["野川公園入口", "自然観察園", "野川沿い"],
    durationNote: "自然観察園見学を含みます",
    highlights: ["自然観察園", "湧水", "野草観察", "バーベキュー場"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "新小金井駅から徒歩15分",
    hasPark: true,
  },
  {
    id: 121,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天"],
    description: "約1700本の桜が咲く都内有数の桜名所。江戸東京たてもの園も隣接。",
    startPoint: "武蔵小金井駅",
    endPoint: "花小金井駅",
    waypoints: ["小金井公園入口", "桜の園", "江戸東京たてもの園", "SL展示"],
    durationNote: "たてもの園見学は含みません",
    highlights: ["約1700本の桜", "江戸東京たてもの園", "SL展示", "サイクリングコース"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "武蔵小金井駅からバス5分",
    hasPark: true,
  },
  {
    id: 122,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "約4800種の植物が楽しめる都立唯一の植物公園。バラ園と深大寺そばも名物。",
    startPoint: "調布駅",
    endPoint: "調布駅",
    waypoints: ["神代植物公園正門", "バラ園", "大温室", "深大寺"],
    durationNote: "深大寺参拝を含みます",
    highlights: ["春秋のバラ園", "大温室", "深大寺参拝", "深大寺そば"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "調布駅からバス20分、入園料500円",
    hasPark: true,
  },
  {
    id: 123,
    ...
    seasons: ["春", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "善福寺川に沿って続く細長い公園。桜並木と野球場、釣り堀があります。",
    startPoint: "高円寺駅",
    endPoint: "西永福駅",
    waypoints: ["和田堀公園入口", "善福寺川沿い", "大宮八幡宮"],
    durationNote: "川沿いを歩く時間です",
    highlights: ["善福寺川の桜並木", "大宮八幡宮", "釣り堀", "野鳥観察"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "高円寺駅から徒歩15分",
    hasPark: true,
  },
  {
    id: 124,
    ...
    seasons: ["春", "夏", "秋", "冬"],
    weatherStyles: ["晴天", "曇天"],
    description: "練馬区と板橋区にまたがる運動公園。野球場やテニスコート、ドッグランが充実。",
    startPoint: "氷川台駅",
    endPoint: "上板橋駅",
    waypoints: ["城北中央公園入口", "けやき広場", "ドッグラン"],
    durationNote: "公園内を周遊する時間です",
    highlights: ["ドッグラン", "けやき広場", "スポーツ施設", "栗原遺跡"],
    recommendedTimes: ["朝", "昼", "夕方"],
    difficulty: "初心者向け",
    accessInfo: "氷川台駅から徒歩15分",
    hasPark: true,
  },
  {
    id: 125,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天"],
    description: "足立区最大の総合公園。大池や野鳥観察、バーベキュー広場が人気。",
    startPoint: "舎人公園駅",
    endPoint: "舎人公園駅",
    waypoints: ["舎人公園入口", "大池", "野草園", "バーベキュー広場"],
    durationNote: "公園内を周遊する時間です",
    highlights: ["大池", "野鳥観察", "バーベキュー広場", "ソリゲレンデ"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "日暮里・舎人ライナー舎人公園駅直結",
    hasPark: true,
  },
  {
    id: 126,
    ...
    seasons: ["春", "夏", "秋", "冬"],
    weatherStyles: ["晴天", "曇天"],
    description: "東京タワーのお膝元に広がる日本最古の公園のひとつ。増上寺と合わせて散策を。",
    startPoint: "芝公園駅",
    endPoint: "御成門駅",
    waypoints: ["芝公園", "増上寺", "東京タワー"],
    durationNote: "増上寺参拝を含みます",
    highlights: ["東京タワービュー", "増上寺", "芝丸山古墳", "梅園"],
    recommendedTimes: ["昼", "夕方", "夜"],
    difficulty: "初心者向け",
    accessInfo: "芝公園駅から徒歩2分",
    hasPark: true,
  },
  {
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "旧林野庁林業試験場跡地を整備した公園。珍しい樹木や野鳥が観察できます。",
    startPoint: "武蔵小山駅",
    endPoint: "西小山駅",
    waypoints: ["林試の森公園入口", "芝生広場", "池"],
    durationNote: "公園内を散策する時間です",
    highlights: ["珍しい樹木", "野鳥観察", "じゃぶじゃぶ池（夏）", "静かな森林浴"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "武蔵小山駅から徒歩10分",
    hasPark: true,
  },
  {
    id: 128,
    ...
    seasons: ["春", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "小石川後楽園と並ぶ江戸初期の大名庭園。コンパクトながら見応えあり。",
    startPoint: "浜松町駅",
    endPoint: "浜松町駅",
    waypoints: ["旧芝離宮恩賜庭園入口", "大泉水", "西湖の堤"],
    durationNote: "庭園を一周する時間です",
    highlights: ["大泉水", "西湖の堤", "雪見灯籠", "藤棚"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "浜松町駅から徒歩1分、入園料150円",
    hasPark: true,
  },
  {
    id: 129,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "武蔵野台地の斜面林を活かした公園。赤塚城跡や植物園も楽しめます。",
    startPoint: "下赤塚駅",
    endPoint: "成増駅",
    waypoints: ["赤塚公園入口", "赤塚城跡", "板橋区立美術館"],
    durationNote: "公園内を散策する時間です",
    highlights: ["赤塚城跡", "斜面林の自然", "板橋区立美術館", "ニリンソウ群生地"],
    recommendedTimes: ["朝", "昼"],
    difficulty: "初心者向け",
    accessInfo: "下赤塚駅から徒歩15分",
    hasPark: true,
  },
  {
    id: 130,
    ...
    seasons: ["春", "夏", "秋"],
    weatherStyles: ["晴天", "曇天"],
    description: "勝海舟ゆかりの池を中心とした公園。ボートや図書館、桜並木が楽しめます。",
    startPoint: "洗足池駅",
    endPoint: "洗足池駅",
    waypoints: ["洗足池", "勝海舟夫妻墓所", "池月橋"],
    durationNote: "池を一周する時間です",
    highlights: ["ボート遊び", "勝海舟墓所", "桜並木", "水生植物園"],
    recommendedTimes: ["朝", "昼", "夕方"],
    difficulty: "初心者向け",
    accessInfo: "洗足池駅から徒歩1分",
    hasPark: true,
  },
];
